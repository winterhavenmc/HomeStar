...
class CooldownMapTest {
	...
	void getCooldownTimeRemainingTest() {
		...
		assertTrue(cooldownMap.getCooldownTimeRemaining(player) <= plugin.getConfig().getLong("teleport-cooldown") * 1000L, "Cooldown time is not less than or equal to config setting.");
	}
